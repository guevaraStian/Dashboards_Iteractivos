...
<h2 style="font-size: 3em; color: #FF0000;">RADARES Y TAMBIEN PROBABILIDADES EN LOTERIA, FUTBOL Y CRIMENES </h2>
...
```
Luego de tener instalado GIT podemos ejecutar los siguientes comandos en la carpeta del proyecto.
